...
def test_fixture_writes_expected_files(synthetic_case: SyntheticCase) -> None:
    sc = synthetic_case
    pdir = sc.patient_dir
...
def test_fixture_plan_dose_equals_dij_times_w(synthetic_case: SyntheticCase) -> None:
    sc = synthetic_case
...
def test_mask_csv_is_index_only(synthetic_case: SyntheticCase) -> None:
